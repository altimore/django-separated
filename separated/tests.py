...
from testproject.testproject.admin import (
    ExportColumnsAndExportViewAdmin,
    NoColumnsExportAdmin,
    OverrideExportColumnsAdmin,
    OverrideExportViewAdmin,
)
...
class SerializerTest(TestCase):
    ...
    def test_serializer_file(self):
        ...
        with tempfile.TemporaryFile() as f:
            ...
            f.seek(0)
            self.assertEqual(
                f.read(), b"Name,Number of models\r\nMy Manufacturer,0\r\n"
            )
